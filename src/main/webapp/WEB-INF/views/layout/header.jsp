    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li><a href="/" class="nav-link px-5 link-dark">Home</a></li>
                <div class="dropdown">
                ...
                <li><a href="/board/paging" class="nav-link px-5 link-dark">고객센터</a></li>
                <c:choose>
                    <c:when test="${not empty sessionScope.loginMemberId}">
                        <c:choose>
                            <c:when test="${sessionScope.loginMemberId eq 'admin'}">
                                <li><a href="/member/admin" class="nav-link px-2">관리자페이지</a></li>
                            </c:when>
                            <c:otherwise>
            ...
            <div class="col-md-3 text-end">
                <c:choose>
                    ...
                    <c:otherwise>
                        <button type="button" class="btn btn-outline-primary me-2" onclick="logout()">로그아웃</button>
                    </c:otherwise>
                </c:choose>
                <button type="button" class="btn btn-primary" onclick="save()">회원가입</button>
            </div>
        </header>
    </div>
</body>
